...
Medusa UI is now compatible with Tailwind CSS v4. In your CSS file that imports Tailwind CSS, add the following `@import`, `@config`, and `@source` directives:
...
Alternatively, you can import the preset CSS directly:
